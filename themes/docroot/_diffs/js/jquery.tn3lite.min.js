...
(function(i) {
  ...
  i.fn.tn3.Gallery.prototype = {
          ...
          switch (n) {
            ...
            default:
              f.special.x[n] && g.click(function(k) {
                var m = !f.items[f.special.x[n]].is(":visible"),
                  t = {
                    id: n,
                    execute: true,
                    active: m
    ...
    parseLayout: function() {
      var d = this.items = {}, h = this.config,
        j = h.active,
        f = h.inactive,
        n = h.cssID.length + 1,
        g = this,
    ...
    resize: function(d, h) {
      ...
      var j = d - this.config.initValues.width,
        f = h - this.config.initValues.height,
        n, g, l = this;
      if (this.items.image) {
    ...
    initResponsive: function(d) {
      ...
      if (typeof d == "number") {
        ...
        var f = this.$c.parent(),
          n = (this.config.width == null ? this.config.initValues.width : this.config.width) / (this.config.height == null ? this.config.initValues.height : this.config.height),
          g = f.width(),
          l = f.height();
  ...
  else for (var c = 0, e = a.length; c < e; c++) {
    b.prefix = a[c];
...
(function(i, b, a) {
    ...
    spin: function(q) {
      ...
      if (!k) {
        var z = 0,
          x = r.fps,
          A = x / r.speed,
          C = (1 - r.opacity) / (A * r.trail / 100),
          D = A / r.lines;
        (function E() {
          z++;
          for (var B = r.lines; B; B--) p.opacity(s, r.lines - B, Math.max(1 - (z + B * D) % A * C, r.opacity), r);
  ...
  (function() {
    ...
    !h(p, "transform") && p.adj ? (m.addRule(".spin-vml", "behavior:url(#default#VML)"), u.prototype.lines = function(r, s) {
      ...
      var y = s.length + s.width,
        z = 2 * y,
        x = -(s.width + s.length) * 2 + "px",
        A = j(v(), {
          position: "absolute",
          top: x,
          left: x
...
(function(i) {
  var b = i.fn.tn3.Transitions = function(c, e, d, h, j) {
    ...
    flatSort: function(c) {
      for (var e = [], d = 0; d < this.gs.length; d++) for (var h = 0; h < this.gs[d].length; h++) e.push(this.gs[d][h]);
      c && e.reverse();
      return e
    },
    randomSort: function() {
    ...
    circleSort: function(c) {
      var e = [],
        d = this.gs.length,
        h = this.gs[0].length,
        j = [Math.floor(d / 2), Math.floor(h / 2)];
      d = d * h;
      h = [
        [1, 0],
        [0, 1],
...
(function(i) {
  function b(g) {
    ...
    n && a({});
    var k = g.baseZ,
      m = h || g.forceIframe ? i('<iframe class="blockUI" style="z-index:' + k+++';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="' + g.iframeSrc + '"></iframe>') : i('<div class="blockUI" style="display:none"></div>'),
      t = i('<div class="blockUI ' + g.cssID + '-overlay" style="z-index:' + k+++';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
  ...
  var h = /MSIE/.test(navigator.userAgent),
    j = /MSIE 6.0/.test(navigator.userAgent),
    f = i.isFunction(document.createElement("div").style.setExpression);
