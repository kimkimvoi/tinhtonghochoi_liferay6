/**
 * Amazing Audio Player - HTML5 Audio Player for Your Website Copyright 2013
 * Magic Hills Pty Ltd All Rights Reserved Website:
 * http://amazingaudioplayer.com Version 2.4
 */
	...
	$.fn.amazingaudioplayer = function(options) {
		var PlayerSkin = function(amazingPlayer, container, options, id) {
			...
			var formatSeconds = function(secs) {
				var hours = Math.floor(secs / 3600), minutes = Math
						.floor(secs % 3600 / 60), seconds = Math
						.ceil(secs % 3600 % 60);
				return (hours == 0 ? "" : hours > 0
						&& hours.toString().length < 2 ? "0" + hours + ":"
						: hours + ":")
						+ (minutes.toString().length < 2 ? "0" + minutes
								: minutes)
						+ ":"
						...
						.bind(
								...
								function(event, data) {
									if (data.image.length > 0)
										instance.$image
												.html("<div class='amazingaudioplayer-image-space' style='display:inline-block;vertical-align:middle;height:100%;'></div><img src='"
														+ data.image
														+ "' style='width:100%;max-width:100%;vertical-align:middle;' />");
									else
										instance.$image.empty()
								});
				this.container
						.append("<div class='amazingaudioplayer-image-clear'></div>")
			}
			if (this.options.showtitle || this.options.showinfo) {
				...
				if (this.options.showtitle) {
					...
					this.container.bind("amazingaudioplayer.updateinfo",
							function(event, data) {
								...
								t = t.replace(/%AUDIO%/g, data.source);
								t = t.replace(/%AUDIOURL%/g,
										encodeURI(data.source));
								instance.$title.html(t)
							});
					this.$text
							.append("<div class='amazingaudioplayer-title-clear'></div>")
				}
				if (this.options.showinfo) {
							...
							.bind(
									...
									function(event, data) {
										var duration = data.duration ? formatSeconds(data.duration)
												: "";
										var t = instance.options.infoformat
					...
					this.$text
							.append("<div class='amazingaudioplayer-info-clear'></div>")
				}
				this.container
						.append("<div class='amazingaudioplayer-text-clear'></div>")
			}
			...
			this.container.bind("amazingaudioplayer.played", function(event,
					currentItem) {
				$play.css({
					display : "none"
				});
			...
			this.container.bind("amazingaudioplayer.paused", function(event,
					currentItem) {
				$play.css({
					display : "block"
				});
			...
			this.container.bind("amazingaudioplayer.stopped", function(event,
					currentItem) {
				$play.css({
					display : "block"
				});
			...
			if (this.options.showprevnext) {
				...
				$prev.click(function() {
					instance.amazingPlayer.audioRun(-2,
						...
						.css(
								{
									...
									"background-repeat" : "no-repeat",
									"background-position" : backgroundPosX[this.options.loop]
											+ " top",
									cursor : "pointer"
								})
						.hover(
			...
			if (this.options.showtitleinbar) {
				...
				this.$bartitle.css({
					...
					overflow : "hidden",
					"white-space" : "nowrap",
					width : this.options.titleinbarwidth,
					height : "auto"
				});
				this.container
						.bind(
								"amazingaudioplayer.updateinfo",
								function(event, data) {
									var t = instance.options.titleinbarformat
											.replace(/%TITLE%/g, data.title);
									t = t.replace(/%ALBUM%/g, data.album);
									t = t.replace(/%ARTIST%/g, data.artist);
									t = t.replace(/%INFO%/g, data.info);
									...
									t = t.replace(/%AUDIOURL%/g,
											encodeURI(data.source));
									instance.$bartitletext = $("<span class='amazingaudioplayer-bar-title-text'>"
											+ t + "</span>");
									...
									if (instance.options.titleinbarscroll) {
										instance.bartitlewidth = instance.$bartitletext
												.width();
										instance.updateTitleInBar = setInterval(
												function() {
													var indent = instance.$bartitle
															.data("text-indent");
													indent--;
													if (indent < -instance.bartitlewidth)
														indent = instance.options.titleinbarwidth;
													instance.$bartitle.css({
														"text-indent" : indent
																+ "px"
													});
													instance.$bartitle.data(
															"text-indent",
															indent)
												}, 1E3 / 25)
									}
			...
			if (this.options.showvolume && !AmazingAudioPlatforms.isIOS()
				...
				this.$volumeButton.css({
					...
					"background-image" : 'url("' + this.options.skinsfolder
							+ this.options.volumeimage + '")',
					"background-repeat" : "no-repeat",
					"background-position" : "left top",
					cursor : "pointer"
				});
				this.$volumeButton.hover(
						function() {
							var backgroundPosX = $(this).css(
									"background-position") ? $(this).css(
				...
				this.$volumeButton
						.click(function() {
							var volume = instance.amazingPlayer.audioPlayer
									.getVolume();
							if (volume > 0) {
							...
							instance.amazingPlayer.audioPlayer
									.setVolume(volume);
				...
				if (this.options.showvolumebar) {
					...
					this.$volumeBar.css({
						...
						left : 0,
						bottom : "100%",
						width : this.options.volumeimagewidth - 2
								* this.options.volumebarpadding,
						height : this.options.volumebarheight - 2
								* this.options.volumebarpadding,
							...
							.bind(
									...
									function(e) {
										var e0 = isTouch ? e.originalEvent.touches[0]
												: e;
										var vol = 1
												- (e0.pageY - instance.$volumeBarAdjust
														.offset().top)
												/ instance.$volumeBarAdjust
														.height();
				...
				this.container
						.bind(
								"amazingaudioplayer.setvolume",
								function(event, volume) {
									volume = volume > 1 ? 1 : volume < 0 ? 0
											: volume;
									var backgroundPosY = instance.$volumeButton
											.css("background-position") ? instance.$volumeButton
											.css("background-position").split(
													" ")[1]
											: instance.$volumeButton
			...
			if (this.options.showtime) {
				...
				$time.appendTo($bar);
				this.container
						.bind("amazingaudioplayer.playprogress",
								function(event, data) {
									var current = isNaN(data.current) ? 0
											: data.current;
									var duration = isNaN(data.duration) ? 0
											: data.duration;
									var left = formatSeconds(Math.ceil(duration
											- current / 1E3));
									current = formatSeconds(Math
											.ceil(current / 1E3));
									duration = formatSeconds(Math
											.ceil(duration / 1E3));
									var t = instance.options.timeformat
			...
			if (this.options.showprogress) {
				...
				if (this.options.progresswidthmode != "auto")
					$progress.css({
						width : this.options.progresswidth
					});
				$progressLoaded.css({
					display : "block",
					position : "absolute",
				...
				$progress.bind(
						...
						function(e) {
							...
							var pos = (e0.pageX - $progress.offset().left)
									/ $progress.width();
				...
				this.container.bind("amazingaudioplayer.loadprogress",
						function(event, progress) {
							$progressLoaded.css({
								width : progress + "%"
							})
						});
				this.container.bind("amazingaudioplayer.playprogress",
						function(event, data) {
							var progress = 0;
							if (!isNaN(data.duration) && data.duration > 0)
								progress = Math.ceil(data.current * 100
										/ data.duration);
							$progressPlayed.css({
								width : progress + "%"
							})
			...
			$bar
					.append("<div class='amazingaudioplayer-bar-buttons-clear'></div>");
			this.container
					.append("<div class='amazingaudioplayer-bar-clear'></div>");
			if (this.options.showtracklist) {
				...
				this.$tracklistwrapper.css({
					display : "block",
					width : this.options.tracklistwidth + "px",
					height : "auto"
				});
				...
				if (this.options.showtracklistbackgroundimage)
					this.$tracklistcontainer.css({
						"background-image" : 'url("' + this.options.skinsfolder
				...
				this.container
						.bind(
								"amazingaudioplayer.switched",
								function(event, data) {
									if (data.previous >= 0)
										instance.trackitems[data.previous]
												.removeClass("amazingaudioplayer-track-item-active");
									if (data.current >= 0) {
										instance.trackitems[data.current]
												.addClass("amazingaudioplayer-track-item-active");
										if (instance.options.tracklistitem < instance.amazingPlayer.elemLength) {
											...
											if (instance.tracklistPage != page) {
												...
												if (instance.tracklistPage == 0) {
													instance.$tracklistarrowprev
															.hide();
													instance.$tracklistarrownext
															.show()
				...
				for ( var i = 0; i < this.amazingPlayer.elemLength; i++) {
					...
					t = t.replace(/%AUDIO%/g, data.source);
					t = t.replace(/%AUDIOURL%/g, encodeURI(data.source));
					$track.data("order", i);
					$track.html(t);
				...
				if (this.options.tracklistitem < this.amazingPlayer.elemLength) {
					...
					this.tracklistPageNum = Math
							.ceil(this.amazingPlayer.elemLength
									/ this.options.tracklistitem);
					this.$tracklistarrowprev = $("<div class='amazingaudioplayer-tracklist-arrow-prev'></div>");
					this.$tracklistarrowprev.appendTo(this.$tracklistcontainer);
					this.$tracklistarrowprev
							.css(
									{
										display : "none",
					...
					this.$tracklistarrownext.appendTo(this.$tracklistcontainer);
					this.$tracklistarrownext
							.css(
									{
										display : "block",
										width : this.options.tracklistarrowimagewidth,
				...
				this.container
						.append("<div class='amazingaudioplayer-tracklist-clear'></div>")
			}
/*			if (this.options.addwm
		...
		var FlashHTML5Player = function(amazingPlayer, flashPlayerEngine) {
			...
			this.supportMp3 = !!(a.canPlayType && a.canPlayType("audio/mpeg;")
					.replace(/no/, ""));
			this.supportOgg = !!(a.canPlayType && a.canPlayType(
		...
		FlashHTML5Player.prototype = {
			initFlash : function() {
				...
				AmazingSWFObject.embedSWF(this.flashPlayerEngine, objectId,
						"1", "1", "9.0.0", false, {
							playerid : this.id
						}, {
							wmode : "transparent",
			...
			initHtml5 : function() {
				var html5Object = $("<audio preload='"
						+ (this.amazingPlayer.options.preloadaudio ? "auto"
								: "none") + "'></audio>");
				...
				if (this.isHtml5) {
					...
					for (i = 0; i < audioSource.length; i++)
						if (audioSource[i].type == "audio/mpeg"
								...
								|| audioSource[i].type == "audio/ogg"
								&& this.supportOgg)
							this.html5Object.append("<source src='"
									+ audioSource[i].src + "' type='"
									+ audioSource[i].type + "'></source>");
					this.amazingPlayer.playProgress(0, 0);
					this.html5AudioLoaded = false;
					...
					this.flashAudioLoaded = false;
					if (this.amazingPlayer.options.preloadaudio)
						this.flashLoadAudio(this.getMp3Src())
				}
			},
			html5LoadAudio : function() {
				...
				this.html5LoadUpdate = setInterval(function() {
					if (html5Audio.buffered && html5Audio.buffered.length > 0
			...
			flashLoadAudio : function(mp3Src) {
				...
				if (!AmazingFlashAudioPlayerReady[this.id]) {
					...
					if (this.loadFlashTimeout < 6E3) {
						setTimeout(function() {
							instance.flashLoadAudio(mp3Src)
						}, 100);
						return
					}
				} else {
					if (!this.flashObject)
						this.flashObject = AmazingSWFObject
								.getObjectById("amazingflashaudioplayer-"
										+ this.id);
			...
			play : function() {
				if (this.isHtml5) {
					if (!this.html5AudioLoaded)
						this.html5LoadAudio();
					this.html5Object.get(0).play()
				} else {
					if (!this.flashAudioLoaded)
						this.flashLoadAudio(this.getMp3Src());
			...
			stop : function() {
				if (this.isHtml5) {
					...
					this.flashObject.stopAudio();
				this.isPlaying = false
			},
			setTime : function(pos) {
				if (this.isHtml5)
					this.html5Object.get(0).currentTime = this.html5Object
							.get(0).duration
							* pos;
				else
					this.flashObject.setTime(pos)
			},
			getVolume : function() {
				if (this.isHtml5)
					return this.html5Object.get(0).volume;
				else
					return this.flashObject.getVolume()
			},
			setVolume : function(val) {
				if (this.isHtml5)
					this.html5Object.get(0).volume = val;
				else
					this.flashObject.setVolume(val)
			}
		};
		...
		AmazingAudioPlayer.prototype = {
			...
			readTags : function() {
				var instance = this;
				$("ul.amazingaudioplayer-audios", this.container)
						.find("li")
						.each(
								function() {
									var $this = $(this);
									...
									instance.elemArray
											.push({
												...
												title : $this.data("title")
														&& $this.data("title").length > 0 ? $this
														.data("title")
														: "",
												artist : $this.data("artist")
														&& $this.data("artist").length > 0 ? $this
														.data("artist")
														: "",
												album : $this.data("album")
														&& $this.data("album").length > 0 ? $this
														.data("album")
														: "",
												info : $this.data("info")
														&& $this.data("info").length > 0 ? $this
														.data("info")
														: "",
												duration : $this
														.data("duration") ? $this
			...
			init : function(instance) {
				...
				if (instance.elemLength <= 0)
					return;
				/*if (instance.elemLength > 3
						&& instance.options.addwm
				...
				if (instance.options.autoplay && !AmazingAudioPlatforms.isIOS()
						&& !AmazingAudioPlatforms.isAndroid())
					window.setTimeout(function() {
						instance.playAudio()
					}, instance.options.autoplaytimeout);
				if (instance.options.defaultvolume >= 0)
					instance.setVolume(instance.options.defaultvolume / 100);
			...
			audioRun : function(index, autoPlay) {
				...
				var nextItem;
				if (index == -2)
					nextItem = this.currentItem <= 0 ? this.elemLength - 1
							: this.currentItem - 1;
				else if (index == -1)
					nextItem = this.currentItem >= this.elemLength - 1 ? 0
							: this.currentItem + 1;
				else
					nextItem = index;
					...
					if (amazingAudioPlayerObjects
						...
						for ( var i = 0; i < amazingAudioPlayerObjects.objects.length; i++) {
							if (amazingAudioPlayerObjects.objects[i].id == this.id)
								continue;
							amazingAudioPlayerObjects.objects[i].container
									.trigger("amazingaudioplayer.stop", this.id)
						}
			},
			pauseAudio : function() {
				this.audioPlayer.pause();
				this.container.trigger("amazingaudioplayer.paused",
						this.currentItem)
			},
			stopAudio : function() {
			...
			playProgress : function(current, duration) {
				if (current == 0 && duration == 1E5)
					return;
				var d0 = this.elemArray[this.currentItem].duration * 1E3 > duration ? this.elemArray[this.currentItem].duration * 1E3
						: duration;
				this.container.trigger("amazingaudioplayer.playprogress", {
					current : current,
					duration : d0
				...
				.each(function() {
					...
					if ($(this).data("skin")
						...
						if ($(this).data("skin") in AMAZINGAUDIOPLAYER_SKIN_OPTIONS)
							this.options = $.extend({},
									AMAZINGAUDIOPLAYER_SKIN_OPTIONS[$(this)
					...
					this.options.lvm = bts("104,116,116,112,58,47,47,97,109,97,122,105,110,103,97,117,100,105,111,112,108,97,121,101,114,46,99,111,109,47,119,97,116,101,114,109,97,114,107,47,63,114,101,102,61,112,108,97,121,101,114,119,109");
					var defaultOptions = {
						autoplay : false,
						loop : 0,
						random : true,
					...
					this.options.pvm = bts("80,111,119,101,114,101,100,32,98,121,32,65,109,97,122,105,110,103,32,65,117,100,105,111,32,80,108,97,121,101,114");
					...
					if (this.options.skinsfolder.length > 0
					...
					var object = new AmazingAudioPlayer($(this), this.options,
							audioplayerid);
...
if (typeof amazingaudioplayerId === "undefined")
	var amazingaudioplayerId = 0;
...
if (typeof AmazingFlashAudioPlayerReady === "undefined") {
	...
	function amazingFlashAudioPlayerEventHandler(event, playerid, param, param1) {
		switch (event) {
		case "completed":
			amazingAudioPlayerObjects.objects[playerid].onAudioEnded();
			break;
		case "loadprogress":
			amazingAudioPlayerObjects.objects[playerid].loadProgress(param);
			break;
		case "playprogress":
			amazingAudioPlayerObjects.objects[playerid].playProgress(param,
					param1);
			break
		}
	}
...
var AmazingSWFObject = function() {
	var UNDEF = "undefined", OBJECT = "object", SHOCKWAVE_FLASH = "Shockwave Flash", SHOCKWAVE_FLASH_AX = "ShockwaveFlash.ShockwaveFlash", FLASH_MIME_TYPE = "application/x-shockwave-flash", EXPRESS_INSTALL_ID = "SWFObjectExprInst", ON_READY_STATE_CHANGE = "onreadystatechange", win = window, doc = document, nav = navigator, plugin = false, domLoadFnArr = [ main ], regObjArr = [], objIdArr = [], listenersArr = [], storedAltContent, storedAltContentId, storedCallbackFn, storedCallbackObj, isDomLoaded = false, isExpressInstallActive = false, dynamicStylesheet, dynamicStylesheetMedia, autoHideShow = true, ua = function() {
		var w3cdom = typeof doc.getElementById != UNDEF
				...
				"$1")) : false, ie = !+"\v1", playerVersion = [ 0, 0, 0 ], d = null;
		...
		if (ua.ie && ua.win)
			window.attachEvent("onunload", function() {
				...
				for ( var k in ua)
					ua[k] = null;
				ua = null;
				for ( var l in AmazingSWFObject)
					AmazingSWFObject[l] = null;
