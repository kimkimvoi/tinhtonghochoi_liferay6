...
if (hasPDFImages) {
	...
	downloadMessage = LanguageUtil.get(pageContext, "download") + " (" + TextFormatter.formatKB(fileEntry.getFileVersion().getSize(), locale) + "k)";
	downloadURL = DLUtil.getPreviewURL(fileEntry, fileEntry.getFileVersion(), themeDisplay, StringPool.BLANK);
	%>
...
<%}else{%>
<h2><liferay-ui:message key="liferayDocumentViewer.UnableViewDocument" /></h2>
<%}%>