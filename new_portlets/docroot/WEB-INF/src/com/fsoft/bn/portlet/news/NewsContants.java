...
public class NewsContants {
	...
	public final class PORTLET_NAME {
		...
		public static final String AUDIO_DETAIL = "audiodetail_WAR_tinhdoportlet";
		public static final String ALL_NEWS_BY_CATEGORY = "listallnewsbycategory_WAR_bacninhportlet";
	}
	...
	public final class XSD_ELEMENT_NAME {
		...
		public static final String VOTE_QUESTION = "votequestion";
	}
	...
	public final class FRIENDLY_URL {
		public static final String VIEW_DETAIL = "/chi-tiet-tin-tuc";
	...
	public static final String DISPLAY_TYPE_AUIDO = "portlet.news.config.display-type.audio";
	public static final String DISPLAY_TYPE_VIDEO = "portlet.news.config.display-type.video";

	public static final String[] DISPLAY_TYPES = new String[] { DISPLAY_TYPE_TITLE_ONLY, DISPLAY_TYPE_SUMMARY, DISPLAY_TYPE_VISITOR,DISPLAY_TYPE_AUIDO,DISPLAY_TYPE_VIDEO };
