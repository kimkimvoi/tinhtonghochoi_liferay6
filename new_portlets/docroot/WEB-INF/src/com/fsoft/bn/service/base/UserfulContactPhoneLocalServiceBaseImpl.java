...
/**
 * The base implementation of the userful contact phone local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.UserfulContactPhoneLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.UserfulContactPhoneLocalServiceImpl
 * @see com.fsoft.bn.service.UserfulContactPhoneLocalServiceUtil
 * @generated
 */
public abstract class UserfulContactPhoneLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserfulContactPhoneLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.UserfulContactPhoneLocalServiceUtil} to access the userful contact phone local service.
	 */
	...
	public UserfulContactPhone addUserfulContactPhone(
		UserfulContactPhone userfulContactPhone) throws SystemException {
		userfulContactPhone.setNew(true);

		return userfulContactPhonePersistence.update(userfulContactPhone, false);
	}
	 ...
	 */
	public UserfulContactPhone createUserfulContactPhone(
		String userful_contact_phone_id) {
		return userfulContactPhonePersistence.create(userful_contact_phone_id);
	}
	...
	public UserfulContactPhone deleteUserfulContactPhone(
		String userful_contact_phone_id)
		throws PortalException, SystemException {
		return userfulContactPhonePersistence.remove(userful_contact_phone_id);
	}
	...
	public UserfulContactPhone deleteUserfulContactPhone(
		UserfulContactPhone userfulContactPhone) throws SystemException {
		return userfulContactPhonePersistence.remove(userfulContactPhone);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(UserfulContactPhone.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userfulContactPhonePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userfulContactPhonePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserfulContactPhone fetchUserfulContactPhone(
		String userful_contact_phone_id) throws SystemException {
		return userfulContactPhonePersistence.fetchByPrimaryKey(userful_contact_phone_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserfulContactPhone getUserfulContactPhone(
		String userful_contact_phone_id)
		throws PortalException, SystemException {
		return userfulContactPhonePersistence.findByPrimaryKey(userful_contact_phone_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userfulContactPhonePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserfulContactPhone> getUserfulContactPhones(int start, int end)
		throws SystemException {
		return userfulContactPhonePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserfulContactPhonesCount() throws SystemException {
		return userfulContactPhonePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserfulContactPhone updateUserfulContactPhone(
		UserfulContactPhone userfulContactPhone) throws SystemException {
		return updateUserfulContactPhone(userfulContactPhone, true);
	}
	...
	public UserfulContactPhone updateUserfulContactPhone(
		...
		return userfulContactPhonePersistence.update(userfulContactPhone, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.UserfulContactPhone",
			userfulContactPhoneLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.UserfulContactPhone");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userfulContactPhonePersistence.getDataSource();
	...
	private UserfulContactPhoneLocalServiceClpInvoker _clpInvoker = new UserfulContactPhoneLocalServiceClpInvoker();
}