...
/**
 * The base implementation of the b n news local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.BNNewsLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 ...
 * @generated
 */
public abstract class BNNewsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BNNewsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.BNNewsLocalServiceUtil} to access the b n news local service.
	 */
	...
	public BNNews addBNNews(BNNews bnNews) throws SystemException {
		bnNews.setNew(true);

		return bnNewsPersistence.update(bnNews, false);
	}
	 ...
	 */
	public BNNews createBNNews(long newsId) {
		return bnNewsPersistence.create(newsId);
	}
	...
	public BNNews deleteBNNews(long newsId)
		throws PortalException, SystemException {
		return bnNewsPersistence.remove(newsId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BNNews deleteBNNews(BNNews bnNews) throws SystemException {
		return bnNewsPersistence.remove(bnNews);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(BNNews.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bnNewsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return bnNewsPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bnNewsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public BNNews fetchBNNews(long newsId) throws SystemException {
		return bnNewsPersistence.fetchByPrimaryKey(newsId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BNNews getBNNews(long newsId)
		throws PortalException, SystemException {
		return bnNewsPersistence.findByPrimaryKey(newsId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bnNewsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<BNNews> getBNNewses(int start, int end)
		throws SystemException {
		return bnNewsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getBNNewsesCount() throws SystemException {
		return bnNewsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BNNews updateBNNews(BNNews bnNews) throws SystemException {
		return updateBNNews(bnNews, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BNNews updateBNNews(BNNews bnNews, boolean merge)
		throws SystemException {
		bnNews.setNew(false);

		return bnNewsPersistence.update(bnNews, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.BNNews",
			bnNewsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.BNNews");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bnNewsPersistence.getDataSource();
	...
	private BNNewsLocalServiceClpInvoker _clpInvoker = new BNNewsLocalServiceClpInvoker();
}