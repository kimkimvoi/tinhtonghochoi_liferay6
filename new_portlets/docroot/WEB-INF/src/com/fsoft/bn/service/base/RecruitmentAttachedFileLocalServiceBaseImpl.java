...
/**
 * The base implementation of the recruitment attached file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.RecruitmentAttachedFileLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.RecruitmentAttachedFileLocalServiceImpl
 * @see com.fsoft.bn.service.RecruitmentAttachedFileLocalServiceUtil
 * @generated
 */
public abstract class RecruitmentAttachedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecruitmentAttachedFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.RecruitmentAttachedFileLocalServiceUtil} to access the recruitment attached file local service.
	 */
	...
	public RecruitmentAttachedFile addRecruitmentAttachedFile(
		RecruitmentAttachedFile recruitmentAttachedFile)
		throws SystemException {
		recruitmentAttachedFile.setNew(true);

		return recruitmentAttachedFilePersistence.update(recruitmentAttachedFile,
			false);
	}
	 ...
	 */
	public RecruitmentAttachedFile createRecruitmentAttachedFile(
		String recruitment_attached_id) {
		return recruitmentAttachedFilePersistence.create(recruitment_attached_id);
	}
	...
	public RecruitmentAttachedFile deleteRecruitmentAttachedFile(
		String recruitment_attached_id) throws PortalException, SystemException {
		return recruitmentAttachedFilePersistence.remove(recruitment_attached_id);
	}
	...
	public RecruitmentAttachedFile deleteRecruitmentAttachedFile(
		RecruitmentAttachedFile recruitmentAttachedFile)
		throws SystemException {
		return recruitmentAttachedFilePersistence.remove(recruitmentAttachedFile);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(RecruitmentAttachedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentAttachedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public RecruitmentAttachedFile fetchRecruitmentAttachedFile(
		String recruitment_attached_id) throws SystemException {
		return recruitmentAttachedFilePersistence.fetchByPrimaryKey(recruitment_attached_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RecruitmentAttachedFile getRecruitmentAttachedFile(
		String recruitment_attached_id) throws PortalException, SystemException {
		return recruitmentAttachedFilePersistence.findByPrimaryKey(recruitment_attached_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recruitmentAttachedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RecruitmentAttachedFile> getRecruitmentAttachedFiles(
		int start, int end) throws SystemException {
		return recruitmentAttachedFilePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRecruitmentAttachedFilesCount() throws SystemException {
		return recruitmentAttachedFilePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RecruitmentAttachedFile updateRecruitmentAttachedFile(
		RecruitmentAttachedFile recruitmentAttachedFile)
		throws SystemException {
		return updateRecruitmentAttachedFile(recruitmentAttachedFile, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.RecruitmentAttachedFile",
			recruitmentAttachedFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.RecruitmentAttachedFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recruitmentAttachedFilePersistence.getDataSource();
	...
	private RecruitmentAttachedFileLocalServiceClpInvoker _clpInvoker = new RecruitmentAttachedFileLocalServiceClpInvoker();
}