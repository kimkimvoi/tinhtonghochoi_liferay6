...
/**
 * The base implementation of the enrolment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.EnrolmentLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.EnrolmentLocalServiceImpl
 * @see com.fsoft.bn.service.EnrolmentLocalServiceUtil
 * @generated
 */
public abstract class EnrolmentLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EnrolmentLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.EnrolmentLocalServiceUtil} to access the enrolment local service.
	 */

	/**
	 * Adds the enrolment to the database. Also notifies the appropriate model listeners.
	 *
	 * @param enrolment the enrolment
	 * @return the enrolment that was added
	...
	public Enrolment addEnrolment(Enrolment enrolment)
		...
		return enrolmentPersistence.update(enrolment, false);
	}
	 ...
	 */
	public Enrolment createEnrolment(String enrolment_id) {
		return enrolmentPersistence.create(enrolment_id);
	}

	/**
	 * Deletes the enrolment with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param enrolment_id the primary key of the enrolment
	 * @return the enrolment that was removed
	 * @throws PortalException if a enrolment with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public Enrolment deleteEnrolment(String enrolment_id)
		throws PortalException, SystemException {
		return enrolmentPersistence.remove(enrolment_id);
	}

	/**
	 * Deletes the enrolment from the database. Also notifies the appropriate model listeners.
	 *
	 * @param enrolment the enrolment
	 * @return the enrolment that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public Enrolment deleteEnrolment(Enrolment enrolment)
		throws SystemException {
		return enrolmentPersistence.remove(enrolment);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Enrolment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return enrolmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return enrolmentPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return enrolmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Enrolment fetchEnrolment(String enrolment_id)
		throws SystemException {
		return enrolmentPersistence.fetchByPrimaryKey(enrolment_id);
	}

	/**
	 * Returns the enrolment with the primary key.
	 *
	 * @param enrolment_id the primary key of the enrolment
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Enrolment getEnrolment(String enrolment_id)
		throws PortalException, SystemException {
		return enrolmentPersistence.findByPrimaryKey(enrolment_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return enrolmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Enrolment> getEnrolments(int start, int end)
		throws SystemException {
		return enrolmentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getEnrolmentsCount() throws SystemException {
		return enrolmentPersistence.countAll();
	}

	/**
	 * Updates the enrolment in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param enrolment the enrolment
	 * @return the enrolment that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Enrolment updateEnrolment(Enrolment enrolment)
		throws SystemException {
		return updateEnrolment(enrolment, true);
	}
	 ...
	 *
	 * @param enrolment the enrolment
	 * @param merge whether to merge the enrolment with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the enrolment that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Enrolment updateEnrolment(Enrolment enrolment, boolean merge)
		throws SystemException {
		enrolment.setNew(false);

		return enrolmentPersistence.update(enrolment, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.Enrolment",
			enrolmentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.Enrolment");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = enrolmentPersistence.getDataSource();
	...
	private EnrolmentLocalServiceClpInvoker _clpInvoker = new EnrolmentLocalServiceClpInvoker();
}