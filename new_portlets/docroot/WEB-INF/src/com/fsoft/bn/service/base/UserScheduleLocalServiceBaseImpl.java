...
/**
 * The base implementation of the user schedule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.UserScheduleLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 ...
 * @generated
 */
public abstract class UserScheduleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserScheduleLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.UserScheduleLocalServiceUtil} to access the user schedule local service.
	 */
	...
	public UserSchedule addUserSchedule(UserSchedule userSchedule)
		...
		return userSchedulePersistence.update(userSchedule, false);
	}
	 ...
	 */
	public UserSchedule createUserSchedule(String user_schedule_id) {
		return userSchedulePersistence.create(user_schedule_id);
	}
	...
	public UserSchedule deleteUserSchedule(String user_schedule_id)
		throws PortalException, SystemException {
		return userSchedulePersistence.remove(user_schedule_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserSchedule deleteUserSchedule(UserSchedule userSchedule)
		throws SystemException {
		return userSchedulePersistence.remove(userSchedule);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(UserSchedule.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSchedulePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userSchedulePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public UserSchedule fetchUserSchedule(String user_schedule_id)
		throws SystemException {
		return userSchedulePersistence.fetchByPrimaryKey(user_schedule_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public UserSchedule getUserSchedule(String user_schedule_id)
		throws PortalException, SystemException {
		return userSchedulePersistence.findByPrimaryKey(user_schedule_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userSchedulePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<UserSchedule> getUserSchedules(int start, int end)
		throws SystemException {
		return userSchedulePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getUserSchedulesCount() throws SystemException {
		return userSchedulePersistence.countAll();
	}
	...
	public UserSchedule updateUserSchedule(UserSchedule userSchedule)
		throws SystemException {
		return updateUserSchedule(userSchedule, true);
	}
	...
	public UserSchedule updateUserSchedule(UserSchedule userSchedule,
		...
		return userSchedulePersistence.update(userSchedule, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.UserSchedule",
			userScheduleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.UserSchedule");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userSchedulePersistence.getDataSource();
	...
	private UserScheduleLocalServiceClpInvoker _clpInvoker = new UserScheduleLocalServiceClpInvoker();
}