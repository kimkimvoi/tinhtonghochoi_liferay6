...
/**
 * The base implementation of the schedule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.ScheduleLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
...
public abstract class ScheduleLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ScheduleLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.ScheduleLocalServiceUtil} to access the schedule local service.
	 */
	...
	public Schedule addSchedule(Schedule schedule) throws SystemException {
		...
		return schedulePersistence.update(schedule, false);
	}
	 ...
	 */
	public Schedule createSchedule(String schedule_id) {
		return schedulePersistence.create(schedule_id);
	}
	...
	public Schedule deleteSchedule(String schedule_id)
		...
		return schedulePersistence.remove(schedule_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Schedule deleteSchedule(Schedule schedule) throws SystemException {
	...
	public Schedule fetchSchedule(String schedule_id) throws SystemException {
		return schedulePersistence.fetchByPrimaryKey(schedule_id);
	}
	...
	public Schedule getSchedule(String schedule_id)
		throws PortalException, SystemException {
		return schedulePersistence.findByPrimaryKey(schedule_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSchedulesCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Schedule updateSchedule(Schedule schedule) throws SystemException {
		return updateSchedule(schedule, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Schedule updateSchedule(Schedule schedule, boolean merge)
		throws SystemException {
		schedule.setNew(false);

		return schedulePersistence.update(schedule, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.Schedule",
			scheduleLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.Schedule");
	}
	...
	private ScheduleLocalServiceClpInvoker _clpInvoker = new ScheduleLocalServiceClpInvoker();
}