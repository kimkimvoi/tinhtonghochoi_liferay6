...
/**
 * The base implementation of the investment projects local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.InvestmentProjectsLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.InvestmentProjectsLocalServiceImpl
 * @see com.fsoft.bn.service.InvestmentProjectsLocalServiceUtil
 * @generated
 */
public abstract class InvestmentProjectsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements InvestmentProjectsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.InvestmentProjectsLocalServiceUtil} to access the investment projects local service.
	 */
	...
	public InvestmentProjects addInvestmentProjects(
		InvestmentProjects investmentProjects) throws SystemException {
		investmentProjects.setNew(true);

		return investmentProjectsPersistence.update(investmentProjects, false);
	}
	 ...
	 */
	public InvestmentProjects createInvestmentProjects(String project_id) {
		return investmentProjectsPersistence.create(project_id);
	}
	...
	public InvestmentProjects deleteInvestmentProjects(String project_id)
		throws PortalException, SystemException {
		return investmentProjectsPersistence.remove(project_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public InvestmentProjects deleteInvestmentProjects(
		InvestmentProjects investmentProjects) throws SystemException {
		return investmentProjectsPersistence.remove(investmentProjects);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(InvestmentProjects.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return investmentProjectsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return investmentProjectsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public InvestmentProjects fetchInvestmentProjects(String project_id)
		throws SystemException {
		return investmentProjectsPersistence.fetchByPrimaryKey(project_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public InvestmentProjects getInvestmentProjects(String project_id)
		throws PortalException, SystemException {
		return investmentProjectsPersistence.findByPrimaryKey(project_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return investmentProjectsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<InvestmentProjects> getInvestmentProjectses(int start, int end)
		throws SystemException {
		return investmentProjectsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getInvestmentProjectsesCount() throws SystemException {
		return investmentProjectsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public InvestmentProjects updateInvestmentProjects(
		InvestmentProjects investmentProjects) throws SystemException {
		return updateInvestmentProjects(investmentProjects, true);
	}
	...
	public InvestmentProjects updateInvestmentProjects(
		...
		return investmentProjectsPersistence.update(investmentProjects, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.InvestmentProjects",
			investmentProjectsLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.InvestmentProjects");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = investmentProjectsPersistence.getDataSource();
	...
	private InvestmentProjectsLocalServiceClpInvoker _clpInvoker = new InvestmentProjectsLocalServiceClpInvoker();
}