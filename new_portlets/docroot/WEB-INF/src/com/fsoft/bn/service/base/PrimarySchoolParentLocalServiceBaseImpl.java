...
/**
 * The base implementation of the primary school parent local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.PrimarySchoolParentLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.PrimarySchoolParentLocalServiceImpl
 * @see com.fsoft.bn.service.PrimarySchoolParentLocalServiceUtil
 * @generated
 */
public abstract class PrimarySchoolParentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PrimarySchoolParentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.PrimarySchoolParentLocalServiceUtil} to access the primary school parent local service.
	 */
	...
	public PrimarySchoolParent addPrimarySchoolParent(
		PrimarySchoolParent primarySchoolParent) throws SystemException {
		primarySchoolParent.setNew(true);

		return primarySchoolParentPersistence.update(primarySchoolParent, false);
	}
	 ...
	 */
	public PrimarySchoolParent createPrimarySchoolParent(
		String primarySchoolParent_id) {
		return primarySchoolParentPersistence.create(primarySchoolParent_id);
	}
	...
	public PrimarySchoolParent deletePrimarySchoolParent(
		String primarySchoolParent_id) throws PortalException, SystemException {
		return primarySchoolParentPersistence.remove(primarySchoolParent_id);
	}
	...
	public PrimarySchoolParent deletePrimarySchoolParent(
		PrimarySchoolParent primarySchoolParent) throws SystemException {
		return primarySchoolParentPersistence.remove(primarySchoolParent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PrimarySchoolParent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return primarySchoolParentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return primarySchoolParentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PrimarySchoolParent fetchPrimarySchoolParent(
		String primarySchoolParent_id) throws SystemException {
		return primarySchoolParentPersistence.fetchByPrimaryKey(primarySchoolParent_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PrimarySchoolParent getPrimarySchoolParent(
		String primarySchoolParent_id) throws PortalException, SystemException {
		return primarySchoolParentPersistence.findByPrimaryKey(primarySchoolParent_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return primarySchoolParentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PrimarySchoolParent> getPrimarySchoolParents(int start, int end)
		throws SystemException {
		return primarySchoolParentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPrimarySchoolParentsCount() throws SystemException {
		return primarySchoolParentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PrimarySchoolParent updatePrimarySchoolParent(
		PrimarySchoolParent primarySchoolParent) throws SystemException {
		return updatePrimarySchoolParent(primarySchoolParent, true);
	}
	...
	public PrimarySchoolParent updatePrimarySchoolParent(
		...
		return primarySchoolParentPersistence.update(primarySchoolParent, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.PrimarySchoolParent",
			primarySchoolParentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = primarySchoolParentPersistence.getDataSource();
	...
	private PrimarySchoolParentLocalServiceClpInvoker _clpInvoker = new PrimarySchoolParentLocalServiceClpInvoker();
}