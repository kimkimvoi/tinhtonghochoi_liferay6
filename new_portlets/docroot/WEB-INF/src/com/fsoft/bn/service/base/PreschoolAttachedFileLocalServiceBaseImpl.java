...
/**
 * The base implementation of the preschool attached file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.PreschoolAttachedFileLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.PreschoolAttachedFileLocalServiceImpl
 * @see com.fsoft.bn.service.PreschoolAttachedFileLocalServiceUtil
 * @generated
 */
public abstract class PreschoolAttachedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PreschoolAttachedFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.PreschoolAttachedFileLocalServiceUtil} to access the preschool attached file local service.
	 */
	...
	public PreschoolAttachedFile addPreschoolAttachedFile(
		PreschoolAttachedFile preschoolAttachedFile) throws SystemException {
		preschoolAttachedFile.setNew(true);

		return preschoolAttachedFilePersistence.update(preschoolAttachedFile,
			false);
	}
	 ...
	 */
	public PreschoolAttachedFile createPreschoolAttachedFile(
		String preschool_attached_id) {
		return preschoolAttachedFilePersistence.create(preschool_attached_id);
	}
	...
	public PreschoolAttachedFile deletePreschoolAttachedFile(
		String preschool_attached_id) throws PortalException, SystemException {
		return preschoolAttachedFilePersistence.remove(preschool_attached_id);
	}
	...
	public PreschoolAttachedFile deletePreschoolAttachedFile(
		PreschoolAttachedFile preschoolAttachedFile) throws SystemException {
		return preschoolAttachedFilePersistence.remove(preschoolAttachedFile);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PreschoolAttachedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return preschoolAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return preschoolAttachedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PreschoolAttachedFile fetchPreschoolAttachedFile(
		String preschool_attached_id) throws SystemException {
		return preschoolAttachedFilePersistence.fetchByPrimaryKey(preschool_attached_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PreschoolAttachedFile getPreschoolAttachedFile(
		String preschool_attached_id) throws PortalException, SystemException {
		return preschoolAttachedFilePersistence.findByPrimaryKey(preschool_attached_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return preschoolAttachedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PreschoolAttachedFile> getPreschoolAttachedFiles(int start,
		int end) throws SystemException {
		return preschoolAttachedFilePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPreschoolAttachedFilesCount() throws SystemException {
		return preschoolAttachedFilePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolAttachedFile updatePreschoolAttachedFile(
		PreschoolAttachedFile preschoolAttachedFile) throws SystemException {
		return updatePreschoolAttachedFile(preschoolAttachedFile, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.PreschoolAttachedFile",
			preschoolAttachedFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.PreschoolAttachedFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = preschoolAttachedFilePersistence.getDataSource();
	...
	private PreschoolAttachedFileLocalServiceClpInvoker _clpInvoker = new PreschoolAttachedFileLocalServiceClpInvoker();
}