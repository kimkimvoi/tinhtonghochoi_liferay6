...
/**
 * The base implementation of the primary school attached file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.PrimarySchoolAttachedFileLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.PrimarySchoolAttachedFileLocalServiceImpl
 * @see com.fsoft.bn.service.PrimarySchoolAttachedFileLocalServiceUtil
 * @generated
 */
public abstract class PrimarySchoolAttachedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements PrimarySchoolAttachedFileLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.PrimarySchoolAttachedFileLocalServiceUtil} to access the primary school attached file local service.
	 */
	...
	public PrimarySchoolAttachedFile addPrimarySchoolAttachedFile(
		PrimarySchoolAttachedFile primarySchoolAttachedFile)
		throws SystemException {
		primarySchoolAttachedFile.setNew(true);

		return primarySchoolAttachedFilePersistence.update(primarySchoolAttachedFile,
			false);
	}
	 ...
	 */
	public PrimarySchoolAttachedFile createPrimarySchoolAttachedFile(
		String primarySchool_attached_id) {
		return primarySchoolAttachedFilePersistence.create(primarySchool_attached_id);
	}
	...
	public PrimarySchoolAttachedFile deletePrimarySchoolAttachedFile(
		String primarySchool_attached_id)
		throws PortalException, SystemException {
		return primarySchoolAttachedFilePersistence.remove(primarySchool_attached_id);
	}
	...
	public PrimarySchoolAttachedFile deletePrimarySchoolAttachedFile(
		PrimarySchoolAttachedFile primarySchoolAttachedFile)
		throws SystemException {
		return primarySchoolAttachedFilePersistence.remove(primarySchoolAttachedFile);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PrimarySchoolAttachedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return primarySchoolAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return primarySchoolAttachedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PrimarySchoolAttachedFile fetchPrimarySchoolAttachedFile(
		String primarySchool_attached_id) throws SystemException {
		return primarySchoolAttachedFilePersistence.fetchByPrimaryKey(primarySchool_attached_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PrimarySchoolAttachedFile getPrimarySchoolAttachedFile(
		String primarySchool_attached_id)
		throws PortalException, SystemException {
		return primarySchoolAttachedFilePersistence.findByPrimaryKey(primarySchool_attached_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return primarySchoolAttachedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PrimarySchoolAttachedFile> getPrimarySchoolAttachedFiles(
		int start, int end) throws SystemException {
		return primarySchoolAttachedFilePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPrimarySchoolAttachedFilesCount() throws SystemException {
		return primarySchoolAttachedFilePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PrimarySchoolAttachedFile updatePrimarySchoolAttachedFile(
		PrimarySchoolAttachedFile primarySchoolAttachedFile)
		throws SystemException {
		return updatePrimarySchoolAttachedFile(primarySchoolAttachedFile, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.PrimarySchoolAttachedFile",
			primarySchoolAttachedFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.PrimarySchoolAttachedFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = primarySchoolAttachedFilePersistence.getDataSource();
	...
	private PrimarySchoolAttachedFileLocalServiceClpInvoker _clpInvoker = new PrimarySchoolAttachedFileLocalServiceClpInvoker();
}