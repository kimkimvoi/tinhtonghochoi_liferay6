...
/**
 * The base implementation of the recruitment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.RecruitmentLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.RecruitmentLocalServiceImpl
 * @see com.fsoft.bn.service.RecruitmentLocalServiceUtil
 * @generated
 */
public abstract class RecruitmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecruitmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.RecruitmentLocalServiceUtil} to access the recruitment local service.
	 */
	...
	public Recruitment addRecruitment(Recruitment recruitment)
		...
		return recruitmentPersistence.update(recruitment, false);
	}
	 ...
	 */
	public Recruitment createRecruitment(String recruitment_id) {
		return recruitmentPersistence.create(recruitment_id);
	}
	...
	public Recruitment deleteRecruitment(String recruitment_id)
		throws PortalException, SystemException {
		return recruitmentPersistence.remove(recruitment_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Recruitment deleteRecruitment(Recruitment recruitment)
		throws SystemException {
		return recruitmentPersistence.remove(recruitment);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Recruitment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return recruitmentPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Recruitment fetchRecruitment(String recruitment_id)
		throws SystemException {
		return recruitmentPersistence.fetchByPrimaryKey(recruitment_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Recruitment getRecruitment(String recruitment_id)
		throws PortalException, SystemException {
		return recruitmentPersistence.findByPrimaryKey(recruitment_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recruitmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Recruitment> getRecruitments(int start, int end)
		throws SystemException {
		return recruitmentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRecruitmentsCount() throws SystemException {
		return recruitmentPersistence.countAll();
	}
	...
	public Recruitment updateRecruitment(Recruitment recruitment)
		throws SystemException {
		return updateRecruitment(recruitment, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Recruitment updateRecruitment(Recruitment recruitment, boolean merge)
		throws SystemException {
		recruitment.setNew(false);

		return recruitmentPersistence.update(recruitment, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.Recruitment",
			recruitmentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.Recruitment");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recruitmentPersistence.getDataSource();
	...
	private RecruitmentLocalServiceClpInvoker _clpInvoker = new RecruitmentLocalServiceClpInvoker();
}