...
/**
 * The base implementation of the preschool student local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.PreschoolStudentLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.PreschoolStudentLocalServiceImpl
 * @see com.fsoft.bn.service.PreschoolStudentLocalServiceUtil
 * @generated
 */
public abstract class PreschoolStudentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PreschoolStudentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.PreschoolStudentLocalServiceUtil} to access the preschool student local service.
	 */

	/**
	 * Adds the preschool student to the database. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolStudent the preschool student
	 * @return the preschool student that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolStudent addPreschoolStudent(
		PreschoolStudent preschoolStudent) throws SystemException {
		preschoolStudent.setNew(true);

		return preschoolStudentPersistence.update(preschoolStudent, false);
	}
	 ...
	 */
	public PreschoolStudent createPreschoolStudent(String student_id) {
		return preschoolStudentPersistence.create(student_id);
	}

	/**
	 * Deletes the preschool student with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param student_id the primary key of the preschool student
	 * @return the preschool student that was removed
	 * @throws PortalException if a preschool student with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public PreschoolStudent deletePreschoolStudent(String student_id)
		throws PortalException, SystemException {
		return preschoolStudentPersistence.remove(student_id);
	}

	/**
	 * Deletes the preschool student from the database. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolStudent the preschool student
	 * @return the preschool student that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public PreschoolStudent deletePreschoolStudent(
		PreschoolStudent preschoolStudent) throws SystemException {
		return preschoolStudentPersistence.remove(preschoolStudent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PreschoolStudent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return preschoolStudentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return preschoolStudentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PreschoolStudent fetchPreschoolStudent(String student_id)
		throws SystemException {
		return preschoolStudentPersistence.fetchByPrimaryKey(student_id);
	}

	/**
	 * Returns the preschool student with the primary key.
	 *
	 * @param student_id the primary key of the preschool student
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PreschoolStudent getPreschoolStudent(String student_id)
		throws PortalException, SystemException {
		return preschoolStudentPersistence.findByPrimaryKey(student_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return preschoolStudentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PreschoolStudent> getPreschoolStudents(int start, int end)
		throws SystemException {
		return preschoolStudentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPreschoolStudentsCount() throws SystemException {
		return preschoolStudentPersistence.countAll();
	}

	/**
	 * Updates the preschool student in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolStudent the preschool student
	 * @return the preschool student that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolStudent updatePreschoolStudent(
		PreschoolStudent preschoolStudent) throws SystemException {
		return updatePreschoolStudent(preschoolStudent, true);
	}
	 ...
	 *
	 * @param preschoolStudent the preschool student
	 * @param merge whether to merge the preschool student with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the preschool student that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolStudent updatePreschoolStudent(
		PreschoolStudent preschoolStudent, boolean merge)
		throws SystemException {
		preschoolStudent.setNew(false);

		return preschoolStudentPersistence.update(preschoolStudent, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.PreschoolStudent",
			preschoolStudentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.PreschoolStudent");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = preschoolStudentPersistence.getDataSource();
	...
	private PreschoolStudentLocalServiceClpInvoker _clpInvoker = new PreschoolStudentLocalServiceClpInvoker();
}