...
/**
 * The base implementation of the enrolment attached file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.EnrolmentAttachedFileLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.EnrolmentAttachedFileLocalServiceImpl
 * @see com.fsoft.bn.service.EnrolmentAttachedFileLocalServiceUtil
 * @generated
 */
public abstract class EnrolmentAttachedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EnrolmentAttachedFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.EnrolmentAttachedFileLocalServiceUtil} to access the enrolment attached file local service.
	 */

	/**
	 * Adds the enrolment attached file to the database. Also notifies the appropriate model listeners.
	 *
	 * @param enrolmentAttachedFile the enrolment attached file
	 * @return the enrolment attached file that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EnrolmentAttachedFile addEnrolmentAttachedFile(
		EnrolmentAttachedFile enrolmentAttachedFile) throws SystemException {
		enrolmentAttachedFile.setNew(true);

		return enrolmentAttachedFilePersistence.update(enrolmentAttachedFile,
			false);
	}
	 ...
	 */
	public EnrolmentAttachedFile createEnrolmentAttachedFile(
		String enrolment_attached_id) {
		return enrolmentAttachedFilePersistence.create(enrolment_attached_id);
	}

	/**
	 * Deletes the enrolment attached file with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a enrolment attached file with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public EnrolmentAttachedFile deleteEnrolmentAttachedFile(
		String enrolment_attached_id) throws PortalException, SystemException {
		return enrolmentAttachedFilePersistence.remove(enrolment_attached_id);
	}

	/**
	 * Deletes the enrolment attached file from the database. Also notifies the appropriate model listeners.
	 *
	 * @param enrolmentAttachedFile the enrolment attached file
	 * @return the enrolment attached file that was removed
	 * @throws SystemException if a system exception occurred
	...
	public EnrolmentAttachedFile deleteEnrolmentAttachedFile(
		EnrolmentAttachedFile enrolmentAttachedFile) throws SystemException {
		return enrolmentAttachedFilePersistence.remove(enrolmentAttachedFile);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(EnrolmentAttachedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return enrolmentAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return enrolmentAttachedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public EnrolmentAttachedFile fetchEnrolmentAttachedFile(
		String enrolment_attached_id) throws SystemException {
		return enrolmentAttachedFilePersistence.fetchByPrimaryKey(enrolment_attached_id);
	}

	/**
	 * Returns the enrolment attached file with the primary key.
	 *
	 * @param enrolment_attached_id the primary key of the enrolment attached file
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public EnrolmentAttachedFile getEnrolmentAttachedFile(
		String enrolment_attached_id) throws PortalException, SystemException {
		return enrolmentAttachedFilePersistence.findByPrimaryKey(enrolment_attached_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return enrolmentAttachedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EnrolmentAttachedFile> getEnrolmentAttachedFiles(int start,
		int end) throws SystemException {
		return enrolmentAttachedFilePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getEnrolmentAttachedFilesCount() throws SystemException {
		return enrolmentAttachedFilePersistence.countAll();
	}

	/**
	 * Updates the enrolment attached file in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param enrolmentAttachedFile the enrolment attached file
	 * @return the enrolment attached file that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EnrolmentAttachedFile updateEnrolmentAttachedFile(
		EnrolmentAttachedFile enrolmentAttachedFile) throws SystemException {
		return updateEnrolmentAttachedFile(enrolmentAttachedFile, true);
	}
	 ...
	 *
	 * @param enrolmentAttachedFile the enrolment attached file
	 * @param merge whether to merge the enrolment attached file with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the enrolment attached file that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.EnrolmentAttachedFile",
			enrolmentAttachedFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.EnrolmentAttachedFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = enrolmentAttachedFilePersistence.getDataSource();
	...
	private EnrolmentAttachedFileLocalServiceClpInvoker _clpInvoker = new EnrolmentAttachedFileLocalServiceClpInvoker();
}