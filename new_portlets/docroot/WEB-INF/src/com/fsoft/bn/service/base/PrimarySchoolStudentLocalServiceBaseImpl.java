...
/**
 * The base implementation of the primary school student local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.PrimarySchoolStudentLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.PrimarySchoolStudentLocalServiceImpl
 * @see com.fsoft.bn.service.PrimarySchoolStudentLocalServiceUtil
 * @generated
 */
public abstract class PrimarySchoolStudentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PrimarySchoolStudentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.PrimarySchoolStudentLocalServiceUtil} to access the primary school student local service.
	 */
	...
	public PrimarySchoolStudent addPrimarySchoolStudent(
		PrimarySchoolStudent primarySchoolStudent) throws SystemException {
		primarySchoolStudent.setNew(true);

		return primarySchoolStudentPersistence.update(primarySchoolStudent,
			false);
	}
	 ...
	 */
	public PrimarySchoolStudent createPrimarySchoolStudent(
		String primaryStudent_id) {
		return primarySchoolStudentPersistence.create(primaryStudent_id);
	}
	...
	public PrimarySchoolStudent deletePrimarySchoolStudent(
		String primaryStudent_id) throws PortalException, SystemException {
		return primarySchoolStudentPersistence.remove(primaryStudent_id);
	}
	...
	public PrimarySchoolStudent deletePrimarySchoolStudent(
		PrimarySchoolStudent primarySchoolStudent) throws SystemException {
		return primarySchoolStudentPersistence.remove(primarySchoolStudent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PrimarySchoolStudent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return primarySchoolStudentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return primarySchoolStudentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PrimarySchoolStudent fetchPrimarySchoolStudent(
		String primaryStudent_id) throws SystemException {
		return primarySchoolStudentPersistence.fetchByPrimaryKey(primaryStudent_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PrimarySchoolStudent getPrimarySchoolStudent(
		String primaryStudent_id) throws PortalException, SystemException {
		return primarySchoolStudentPersistence.findByPrimaryKey(primaryStudent_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return primarySchoolStudentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PrimarySchoolStudent> getPrimarySchoolStudents(int start,
		int end) throws SystemException {
		return primarySchoolStudentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPrimarySchoolStudentsCount() throws SystemException {
		return primarySchoolStudentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PrimarySchoolStudent updatePrimarySchoolStudent(
		PrimarySchoolStudent primarySchoolStudent) throws SystemException {
		return updatePrimarySchoolStudent(primarySchoolStudent, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.PrimarySchoolStudent",
			primarySchoolStudentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.PrimarySchoolStudent");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = primarySchoolStudentPersistence.getDataSource();
	...
	private PrimarySchoolStudentLocalServiceClpInvoker _clpInvoker = new PrimarySchoolStudentLocalServiceClpInvoker();
}