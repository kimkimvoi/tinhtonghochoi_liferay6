...
/**
 * The base implementation of the preschool parent local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.PreschoolParentLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.PreschoolParentLocalServiceImpl
 * @see com.fsoft.bn.service.PreschoolParentLocalServiceUtil
 * @generated
 */
public abstract class PreschoolParentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PreschoolParentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.PreschoolParentLocalServiceUtil} to access the preschool parent local service.
	 */

	/**
	 * Adds the preschool parent to the database. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolParent the preschool parent
	 * @return the preschool parent that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolParent addPreschoolParent(PreschoolParent preschoolParent)
		throws SystemException {
		preschoolParent.setNew(true);

		return preschoolParentPersistence.update(preschoolParent, false);
	}
	 ...
	 */
	public PreschoolParent createPreschoolParent(String preschoolParent_id) {
		return preschoolParentPersistence.create(preschoolParent_id);
	}

	/**
	 * Deletes the preschool parent with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolParent_id the primary key of the preschool parent
	 * @return the preschool parent that was removed
	 * @throws PortalException if a preschool parent with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public PreschoolParent deletePreschoolParent(String preschoolParent_id)
		throws PortalException, SystemException {
		return preschoolParentPersistence.remove(preschoolParent_id);
	}

	/**
	 * Deletes the preschool parent from the database. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolParent the preschool parent
	 * @return the preschool parent that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public PreschoolParent deletePreschoolParent(
		PreschoolParent preschoolParent) throws SystemException {
		return preschoolParentPersistence.remove(preschoolParent);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(PreschoolParent.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return preschoolParentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return preschoolParentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PreschoolParent fetchPreschoolParent(String preschoolParent_id)
		throws SystemException {
		return preschoolParentPersistence.fetchByPrimaryKey(preschoolParent_id);
	}

	/**
	 * Returns the preschool parent with the primary key.
	 *
	 * @param preschoolParent_id the primary key of the preschool parent
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PreschoolParent getPreschoolParent(String preschoolParent_id)
		throws PortalException, SystemException {
		return preschoolParentPersistence.findByPrimaryKey(preschoolParent_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return preschoolParentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PreschoolParent> getPreschoolParents(int start, int end)
		throws SystemException {
		return preschoolParentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPreschoolParentsCount() throws SystemException {
		return preschoolParentPersistence.countAll();
	}

	/**
	 * Updates the preschool parent in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param preschoolParent the preschool parent
	 * @return the preschool parent that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolParent updatePreschoolParent(
		PreschoolParent preschoolParent) throws SystemException {
		return updatePreschoolParent(preschoolParent, true);
	}
	 ...
	 *
	 * @param preschoolParent the preschool parent
	 * @param merge whether to merge the preschool parent with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the preschool parent that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PreschoolParent updatePreschoolParent(
		PreschoolParent preschoolParent, boolean merge)
		throws SystemException {
		preschoolParent.setNew(false);

		return preschoolParentPersistence.update(preschoolParent, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.PreschoolParent",
			preschoolParentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.PreschoolParent");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = preschoolParentPersistence.getDataSource();
	...
	private PreschoolParentLocalServiceClpInvoker _clpInvoker = new PreschoolParentLocalServiceClpInvoker();
}