...
/**
 * The base implementation of the organizations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.OrganizationsLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
...
public abstract class OrganizationsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements OrganizationsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.OrganizationsLocalServiceUtil} to access the organizations local service.
	 */
	...
	public Organizations addOrganizations(Organizations organizations)
		...
		return organizationsPersistence.update(organizations, false);
	}
	 ...
	 */
	public Organizations createOrganizations(long organizations_id) {
		return organizationsPersistence.create(organizations_id);
	}
	...
	public Organizations deleteOrganizations(long organizations_id)
		throws PortalException, SystemException {
		return organizationsPersistence.remove(organizations_id);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Organizations.class,
	...
	public Organizations fetchOrganizations(long organizations_id)
		throws SystemException {
		return organizationsPersistence.fetchByPrimaryKey(organizations_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Organizations getOrganizations(long organizations_id)
		throws PortalException, SystemException {
		return organizationsPersistence.findByPrimaryKey(organizations_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getOrganizationsesCount() throws SystemException {
	...
	public Organizations updateOrganizations(Organizations organizations)
		throws SystemException {
		return updateOrganizations(organizations, true);
	}
	...
	public Organizations updateOrganizations(Organizations organizations,
		...
		return organizationsPersistence.update(organizations, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.Organizations",
	...
	private OrganizationsLocalServiceClpInvoker _clpInvoker = new OrganizationsLocalServiceClpInvoker();
}