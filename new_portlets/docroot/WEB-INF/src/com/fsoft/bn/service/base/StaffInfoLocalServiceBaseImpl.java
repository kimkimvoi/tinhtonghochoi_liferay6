...
/**
 * The base implementation of the staff info local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.StaffInfoLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 ...
 * @generated
 */
public abstract class StaffInfoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements StaffInfoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.StaffInfoLocalServiceUtil} to access the staff info local service.
	 */
	...
	public StaffInfo addStaffInfo(StaffInfo staffInfo)
		...
		return staffInfoPersistence.update(staffInfo, false);
	}
	 ...
	 */
	public StaffInfo createStaffInfo(long staff_id) {
		return staffInfoPersistence.create(staff_id);
	}
	...
	public StaffInfo deleteStaffInfo(long staff_id)
		throws PortalException, SystemException {
		return staffInfoPersistence.remove(staff_id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public StaffInfo deleteStaffInfo(StaffInfo staffInfo)
		throws SystemException {
		return staffInfoPersistence.remove(staffInfo);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(StaffInfo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return staffInfoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return staffInfoPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return staffInfoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public StaffInfo fetchStaffInfo(long staff_id) throws SystemException {
		return staffInfoPersistence.fetchByPrimaryKey(staff_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public StaffInfo getStaffInfo(long staff_id)
		throws PortalException, SystemException {
		return staffInfoPersistence.findByPrimaryKey(staff_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return staffInfoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<StaffInfo> getStaffInfos(int start, int end)
		throws SystemException {
		return staffInfoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getStaffInfosCount() throws SystemException {
		return staffInfoPersistence.countAll();
	}
	...
	public StaffInfo updateStaffInfo(StaffInfo staffInfo)
		throws SystemException {
		return updateStaffInfo(staffInfo, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public StaffInfo updateStaffInfo(StaffInfo staffInfo, boolean merge)
		throws SystemException {
		staffInfo.setNew(false);

		return staffInfoPersistence.update(staffInfo, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.StaffInfo",
			staffInfoLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.StaffInfo");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = staffInfoPersistence.getDataSource();
	...
	private StaffInfoLocalServiceClpInvoker _clpInvoker = new StaffInfoLocalServiceClpInvoker();
}