...
/**
 * The base implementation of the question attached file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.QuestionAttachedFileLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.QuestionAttachedFileLocalServiceImpl
 * @see com.fsoft.bn.service.QuestionAttachedFileLocalServiceUtil
 * @generated
 */
public abstract class QuestionAttachedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements QuestionAttachedFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.QuestionAttachedFileLocalServiceUtil} to access the question attached file local service.
	 */

	/**
	 * Adds the question attached file to the database. Also notifies the appropriate model listeners.
	 *
	 * @param questionAttachedFile the question attached file
	 * @return the question attached file that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public QuestionAttachedFile addQuestionAttachedFile(
		QuestionAttachedFile questionAttachedFile) throws SystemException {
		questionAttachedFile.setNew(true);

		return questionAttachedFilePersistence.update(questionAttachedFile,
			false);
	}
	 ...
	 */
	public QuestionAttachedFile createQuestionAttachedFile(
		String question_attached_id) {
		return questionAttachedFilePersistence.create(question_attached_id);
	}

	/**
	 * Deletes the question attached file with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 ...
	 * @throws PortalException if a question attached file with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public QuestionAttachedFile deleteQuestionAttachedFile(
		String question_attached_id) throws PortalException, SystemException {
		return questionAttachedFilePersistence.remove(question_attached_id);
	}

	/**
	 * Deletes the question attached file from the database. Also notifies the appropriate model listeners.
	 *
	 * @param questionAttachedFile the question attached file
	 * @return the question attached file that was removed
	 * @throws SystemException if a system exception occurred
	...
	public QuestionAttachedFile deleteQuestionAttachedFile(
		QuestionAttachedFile questionAttachedFile) throws SystemException {
		return questionAttachedFilePersistence.remove(questionAttachedFile);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(QuestionAttachedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return questionAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return questionAttachedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public QuestionAttachedFile fetchQuestionAttachedFile(
		String question_attached_id) throws SystemException {
		return questionAttachedFilePersistence.fetchByPrimaryKey(question_attached_id);
	}

	/**
	 * Returns the question attached file with the primary key.
	 *
	 * @param question_attached_id the primary key of the question attached file
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public QuestionAttachedFile getQuestionAttachedFile(
		String question_attached_id) throws PortalException, SystemException {
		return questionAttachedFilePersistence.findByPrimaryKey(question_attached_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return questionAttachedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<QuestionAttachedFile> getQuestionAttachedFiles(int start,
		int end) throws SystemException {
		return questionAttachedFilePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getQuestionAttachedFilesCount() throws SystemException {
		return questionAttachedFilePersistence.countAll();
	}

	/**
	 * Updates the question attached file in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param questionAttachedFile the question attached file
	 * @return the question attached file that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public QuestionAttachedFile updateQuestionAttachedFile(
		QuestionAttachedFile questionAttachedFile) throws SystemException {
		return updateQuestionAttachedFile(questionAttachedFile, true);
	}
	 ...
	 *
	 * @param questionAttachedFile the question attached file
	 * @param merge whether to merge the question attached file with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the question attached file that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.QuestionAttachedFile",
			questionAttachedFileLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.QuestionAttachedFile");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = questionAttachedFilePersistence.getDataSource();
	...
	private QuestionAttachedFileLocalServiceClpInvoker _clpInvoker = new QuestionAttachedFileLocalServiceClpInvoker();
}