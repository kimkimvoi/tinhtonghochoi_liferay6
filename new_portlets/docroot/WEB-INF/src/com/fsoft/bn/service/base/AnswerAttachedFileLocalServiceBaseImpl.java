...
/**
 * The base implementation of the answer attached file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.AnswerAttachedFileLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.AnswerAttachedFileLocalServiceImpl
 * @see com.fsoft.bn.service.AnswerAttachedFileLocalServiceUtil
 * @generated
 */
public abstract class AnswerAttachedFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AnswerAttachedFileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.AnswerAttachedFileLocalServiceUtil} to access the answer attached file local service.
	 */

	/**
	 * Adds the answer attached file to the database. Also notifies the appropriate model listeners.
	 *
	 * @param answerAttachedFile the answer attached file
	 * @return the answer attached file that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AnswerAttachedFile addAnswerAttachedFile(
		AnswerAttachedFile answerAttachedFile) throws SystemException {
		answerAttachedFile.setNew(true);

		return answerAttachedFilePersistence.update(answerAttachedFile, false);
	}
	 ...
	 */
	public AnswerAttachedFile createAnswerAttachedFile(
		String answer_attached_id) {
		return answerAttachedFilePersistence.create(answer_attached_id);
	}

	/**
	 * Deletes the answer attached file with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param answer_attached_id the primary key of the answer attached file
	 * @return the answer attached file that was removed
	 * @throws PortalException if a answer attached file with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public AnswerAttachedFile deleteAnswerAttachedFile(
		String answer_attached_id) throws PortalException, SystemException {
		return answerAttachedFilePersistence.remove(answer_attached_id);
	}

	/**
	 * Deletes the answer attached file from the database. Also notifies the appropriate model listeners.
	 *
	 * @param answerAttachedFile the answer attached file
	 * @return the answer attached file that was removed
	 * @throws SystemException if a system exception occurred
	...
	public AnswerAttachedFile deleteAnswerAttachedFile(
		AnswerAttachedFile answerAttachedFile) throws SystemException {
		return answerAttachedFilePersistence.remove(answerAttachedFile);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AnswerAttachedFile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return answerAttachedFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return answerAttachedFilePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AnswerAttachedFile fetchAnswerAttachedFile(String answer_attached_id)
		throws SystemException {
		return answerAttachedFilePersistence.fetchByPrimaryKey(answer_attached_id);
	}

	/**
	 * Returns the answer attached file with the primary key.
	 *
	 * @param answer_attached_id the primary key of the answer attached file
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AnswerAttachedFile getAnswerAttachedFile(String answer_attached_id)
		throws PortalException, SystemException {
		return answerAttachedFilePersistence.findByPrimaryKey(answer_attached_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return answerAttachedFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AnswerAttachedFile> getAnswerAttachedFiles(int start, int end)
		throws SystemException {
		return answerAttachedFilePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAnswerAttachedFilesCount() throws SystemException {
		return answerAttachedFilePersistence.countAll();
	}

	/**
	 * Updates the answer attached file in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param answerAttachedFile the answer attached file
	 * @return the answer attached file that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AnswerAttachedFile updateAnswerAttachedFile(
		AnswerAttachedFile answerAttachedFile) throws SystemException {
		return updateAnswerAttachedFile(answerAttachedFile, true);
	}
	 ...
	 *
	 * @param answerAttachedFile the answer attached file
	 * @param merge whether to merge the answer attached file with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the answer attached file that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AnswerAttachedFile updateAnswerAttachedFile(
		...
		return answerAttachedFilePersistence.update(answerAttachedFile, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.AnswerAttachedFile",
			answerAttachedFileLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = answerAttachedFilePersistence.getDataSource();
	...
	private AnswerAttachedFileLocalServiceClpInvoker _clpInvoker = new AnswerAttachedFileLocalServiceClpInvoker();
}