...
/**
 * The base implementation of the recruitment educational history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.RecruitmentEducationalHistoryLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.RecruitmentEducationalHistoryLocalServiceImpl
 * @see com.fsoft.bn.service.RecruitmentEducationalHistoryLocalServiceUtil
 * @generated
 */
public abstract class RecruitmentEducationalHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements RecruitmentEducationalHistoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.RecruitmentEducationalHistoryLocalServiceUtil} to access the recruitment educational history local service.
	 */
	...
	public RecruitmentEducationalHistory addRecruitmentEducationalHistory(
		RecruitmentEducationalHistory recruitmentEducationalHistory)
		throws SystemException {
		recruitmentEducationalHistory.setNew(true);

		return recruitmentEducationalHistoryPersistence.update(recruitmentEducationalHistory,
			false);
	}
	 ...
	 */
	public RecruitmentEducationalHistory createRecruitmentEducationalHistory(
		String recruitment_educational_history_id) {
		return recruitmentEducationalHistoryPersistence.create(recruitment_educational_history_id);
	}
	...
	public RecruitmentEducationalHistory deleteRecruitmentEducationalHistory(
		String recruitment_educational_history_id)
		throws PortalException, SystemException {
		return recruitmentEducationalHistoryPersistence.remove(recruitment_educational_history_id);
	}
	...
	public RecruitmentEducationalHistory deleteRecruitmentEducationalHistory(
		RecruitmentEducationalHistory recruitmentEducationalHistory)
		throws SystemException {
		return recruitmentEducationalHistoryPersistence.remove(recruitmentEducationalHistory);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(RecruitmentEducationalHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentEducationalHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentEducationalHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public RecruitmentEducationalHistory fetchRecruitmentEducationalHistory(
		String recruitment_educational_history_id) throws SystemException {
		return recruitmentEducationalHistoryPersistence.fetchByPrimaryKey(recruitment_educational_history_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RecruitmentEducationalHistory getRecruitmentEducationalHistory(
		String recruitment_educational_history_id)
		throws PortalException, SystemException {
		return recruitmentEducationalHistoryPersistence.findByPrimaryKey(recruitment_educational_history_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recruitmentEducationalHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RecruitmentEducationalHistory> getRecruitmentEducationalHistories(
		int start, int end) throws SystemException {
		return recruitmentEducationalHistoryPersistence.findAll(start, end);
	}
	...
	public int getRecruitmentEducationalHistoriesCount()
		throws SystemException {
		return recruitmentEducationalHistoryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RecruitmentEducationalHistory updateRecruitmentEducationalHistory(
		RecruitmentEducationalHistory recruitmentEducationalHistory)
		throws SystemException {
		return updateRecruitmentEducationalHistory(recruitmentEducationalHistory,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.RecruitmentEducationalHistory",
			recruitmentEducationalHistoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.RecruitmentEducationalHistory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recruitmentEducationalHistoryPersistence.getDataSource();
	...
	private RecruitmentEducationalHistoryLocalServiceClpInvoker _clpInvoker = new RecruitmentEducationalHistoryLocalServiceClpInvoker();
}