...
/**
 * The base implementation of the b n contact local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.BNContactLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.BNContactLocalServiceImpl
 * @see com.fsoft.bn.service.BNContactLocalServiceUtil
 * @generated
 */
public abstract class BNContactLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BNContactLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.BNContactLocalServiceUtil} to access the b n contact local service.
	 */
	...
	public BNContact addBNContact(BNContact bnContact)
		throws SystemException {
		bnContact.setNew(true);

		return bnContactPersistence.update(bnContact, false);
	}
	 ...
	 */
	public BNContact createBNContact(long contactId) {
		return bnContactPersistence.create(contactId);
	}
	...
	public BNContact deleteBNContact(long contactId)
		throws PortalException, SystemException {
		return bnContactPersistence.remove(contactId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BNContact deleteBNContact(BNContact bnContact)
		throws SystemException {
		return bnContactPersistence.remove(bnContact);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(BNContact.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return bnContactPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return bnContactPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bnContactPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public BNContact fetchBNContact(long contactId) throws SystemException {
		return bnContactPersistence.fetchByPrimaryKey(contactId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public BNContact getBNContact(long contactId)
		throws PortalException, SystemException {
		return bnContactPersistence.findByPrimaryKey(contactId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bnContactPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<BNContact> getBNContacts(int start, int end)
		throws SystemException {
		return bnContactPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getBNContactsCount() throws SystemException {
		return bnContactPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BNContact updateBNContact(BNContact bnContact)
		throws SystemException {
		return updateBNContact(bnContact, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BNContact updateBNContact(BNContact bnContact, boolean merge)
		throws SystemException {
		bnContact.setNew(false);

		return bnContactPersistence.update(bnContact, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.BNContact",
			bnContactLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.BNContact");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bnContactPersistence.getDataSource();
	...
	private BNContactLocalServiceClpInvoker _clpInvoker = new BNContactLocalServiceClpInvoker();
}