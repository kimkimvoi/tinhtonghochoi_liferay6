...
/**
 * The base implementation of the answer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.AnswerLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.AnswerLocalServiceImpl
 * @see com.fsoft.bn.service.AnswerLocalServiceUtil
 * @generated
 */
public abstract class AnswerLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AnswerLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.AnswerLocalServiceUtil} to access the answer local service.
	 */
	...
	public Answer addAnswer(Answer answer) throws SystemException {
		answer.setNew(true);

		return answerPersistence.update(answer, false);
	}
	 ...
	 */
	public Answer createAnswer(String answer_id) {
		return answerPersistence.create(answer_id);
	}
	...
	public Answer deleteAnswer(String answer_id)
		throws PortalException, SystemException {
		return answerPersistence.remove(answer_id);
	}
	...
	public Answer fetchAnswer(String answer_id) throws SystemException {
		return answerPersistence.fetchByPrimaryKey(answer_id);
	}
	...
	public Answer getAnswer(String answer_id)
		throws PortalException, SystemException {
		return answerPersistence.findByPrimaryKey(answer_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAnswersCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Answer updateAnswer(Answer answer) throws SystemException {
		return updateAnswer(answer, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Answer updateAnswer(Answer answer, boolean merge)
		throws SystemException {
		answer.setNew(false);

		return answerPersistence.update(answer, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.Answer",
			answerLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.fsoft.bn.model.Answer");
	}
	...
	private AnswerLocalServiceClpInvoker _clpInvoker = new AnswerLocalServiceClpInvoker();
}