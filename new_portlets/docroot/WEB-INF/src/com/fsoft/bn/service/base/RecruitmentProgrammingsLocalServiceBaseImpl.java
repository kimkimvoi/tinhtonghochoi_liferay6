...
/**
 * The base implementation of the recruitment programmings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fsoft.bn.service.impl.RecruitmentProgrammingsLocalServiceImpl}.
 * </p>
 *
 * @author FSOFT
 * @see com.fsoft.bn.service.impl.RecruitmentProgrammingsLocalServiceImpl
 * @see com.fsoft.bn.service.RecruitmentProgrammingsLocalServiceUtil
 * @generated
 */
public abstract class RecruitmentProgrammingsLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RecruitmentProgrammingsLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fsoft.bn.service.RecruitmentProgrammingsLocalServiceUtil} to access the recruitment programmings local service.
	 */
	...
	public RecruitmentProgrammings addRecruitmentProgrammings(
		RecruitmentProgrammings recruitmentProgrammings)
		throws SystemException {
		recruitmentProgrammings.setNew(true);

		return recruitmentProgrammingsPersistence.update(recruitmentProgrammings,
			false);
	}
	 ...
	 */
	public RecruitmentProgrammings createRecruitmentProgrammings(
		String recruitment_programmings_id) {
		return recruitmentProgrammingsPersistence.create(recruitment_programmings_id);
	}
	...
	public RecruitmentProgrammings deleteRecruitmentProgrammings(
		String recruitment_programmings_id)
		throws PortalException, SystemException {
		return recruitmentProgrammingsPersistence.remove(recruitment_programmings_id);
	}
	...
	public RecruitmentProgrammings deleteRecruitmentProgrammings(
		RecruitmentProgrammings recruitmentProgrammings)
		throws SystemException {
		return recruitmentProgrammingsPersistence.remove(recruitmentProgrammings);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(RecruitmentProgrammings.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentProgrammingsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return recruitmentProgrammingsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public RecruitmentProgrammings fetchRecruitmentProgrammings(
		String recruitment_programmings_id) throws SystemException {
		return recruitmentProgrammingsPersistence.fetchByPrimaryKey(recruitment_programmings_id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RecruitmentProgrammings getRecruitmentProgrammings(
		String recruitment_programmings_id)
		throws PortalException, SystemException {
		return recruitmentProgrammingsPersistence.findByPrimaryKey(recruitment_programmings_id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return recruitmentProgrammingsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RecruitmentProgrammings> getRecruitmentProgrammingses(
		int start, int end) throws SystemException {
		return recruitmentProgrammingsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRecruitmentProgrammingsesCount() throws SystemException {
		return recruitmentProgrammingsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RecruitmentProgrammings updateRecruitmentProgrammings(
		RecruitmentProgrammings recruitmentProgrammings)
		throws SystemException {
		return updateRecruitmentProgrammings(recruitmentProgrammings, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.fsoft.bn.model.RecruitmentProgrammings",
			recruitmentProgrammingsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = recruitmentProgrammingsPersistence.getDataSource();
	...
	private RecruitmentProgrammingsLocalServiceClpInvoker _clpInvoker = new RecruitmentProgrammingsLocalServiceClpInvoker();
}