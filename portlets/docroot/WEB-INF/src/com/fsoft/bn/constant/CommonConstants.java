...
public final class CommonConstants {
	...
	public static final String [] questionListHeaderKeys = {"portlet.answeredquestions.header.stt"
	...
	public static final String [] staffInfoListHeaderKeys = {"portlet.search-staff.search.headerlist.stt",
		...
		"portlet.search-staff.search.headerlist.role",
		"portlet.search-staff.search.headerlist.phone",
		"portlet.search-staff.search.headerlist.email",
		"portlet.search-staff.search.headerlist.organization"};
	...
	public static String scheduleTitleDateFormat = "portlet.schedule.title.dateformat";
	
	public static String[] legalDocumentsListHeaderKeys = {
		"portlet.legal_documents.table.header.doc_symbols",
		"portlet.legal_documents.table.header.date_publish",
		"portlet.legal_documents.table.header.description",
		"portlet.legal_documents.table.header.doc_domain"
	};
	
	public static String[] department = {
		"Thường trực Tỉnh ủy","Thường trực HĐND tỉnh","Thường trực UBND tỉnh","BCH Đảng bộ tỉnh khóa XVIII","Danh bạ điện tử của các cơ quan, đơn vị",
		"Văn phòng Tỉnh ủy","Văn phòng UBND tỉnh","Sở Kế hoạch Đầu tư","Sở Tư pháp","Sở Y tế",
		"Sở Văn hoá, Thể thao và Du lịch","Sở Tài chính","Sở Nông nghiệp và PTNT","Sở Lao động Thương binh Xã Hội","Sở Khoa học công nghệ",
		"Sở Giao thông Vận tải","Sở Giáo dục và Đào tạo","Sở Nội vụ","Sở Tài nguyên và Môi trường","Sở Xây dựng",
		"Sở Thông tin và Truyền thông","Sở Công Thương","Ban Quản lý khu Công nghiệp","Thanh tra tỉnh","Đài Phát thanh và Truyền hình",
		...
		"Ban Chỉ đạo CNTT tỉnh","Cục Thống kê","Trường Chính Trị Nguyễn Văn Cừ"
	};
	
	public static String[] contactListHeaderKeys = {
		"portlet.contact.table.header.stt",
		"portlet.contact.table.header.name",
		"portlet.contact.table.header.regency",
		"portlet.contact.table.header.phone",
	...
	public static final int PUBLIC_NEWS_PER_PAGE = 5;
	...
	public static final String DATE_FORMET_EN = "yyyy/MM/dd";
	public static final String DATE_FORMET_VI = "dd/MM/yyyy";
	...
	public final class STRUCTURE {
		...
		public static final long GROUP_ID = 180;
		...
		/** ++ START Link Page*/
		public static final String LINK_PAGE_STRUCTURE_ID = "107004";
		public static final long LINK_PAGE_GROUP_ID = 180;
		/** -- END Link Page*/
	}
	public interface DOCUMENTMEDIA {
		String[] PICTURE_MIME_TYPE = {"image/gif", "image/jpeg", "image/png", "image/bmp"};
		String[] VIDEO_MIME_TYPE = {"video/x-flv", "video/mp4"};
		Long ADVERTISEMENT_FILE_ENTRY_TYPE_ID = 116201L;
	}
	...
	public final class PAGING {
		...
		public static final int DEFAULT_PAGE_RANGE = 3;
	...
	public final class PORTLET_NAME {
		public static final String NEWS_BOX_TINHDO = "newsboxtinhdo_WAR_tinhdoportlet";
	}
	...
	public final class PORTLET {
		...
		public final class QUESTION_SUBMIT {
			public static final String NAME ="questionsubmit_WAR_tinhdoportlet";
			public static final String DATA_DICTIONARY_SET ="dataDictionarySet";
			public static final String QUESTION_TYPE ="questionType";
		}
		public final class VIDEO_GALLERY {
			
			public static final long VIDEO_FILE_ENTRY_TYPE_ID = 55603L;
			public static final String FILE_ENTRY_TYPE_ID ="fileEntryTypeId";
			public static final String CREATE_DATE ="createDate";
			public static final String VIDEO_LIST ="videoList";
			public static final String NAME ="videogallery_WAR_tinhdoportlet";
