 ...
 * @author FSOFT
 */
public class ScheduleLocalServiceClp implements ScheduleLocalService {
	public ScheduleLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName19 = "getScheduleBy";

		_methodParameterTypes19 = new String[] { "int", "int", "java.util.Locale" };

		_methodName20 = "getScheduleBy";

		_methodParameterTypes20 = new String[] {
				"java.lang.String", "int", "int", "java.util.Locale"
			};

		_methodName21 = "getWeekScheduleBy";

		_methodParameterTypes21 = new String[] {
				"int", "int", "int", "java.util.Locale"
			};

		_methodName22 = "deleteSchedule";

		_methodParameterTypes22 = new String[] {
				"java.lang.String", "java.util.Date"
			};

		_methodName23 = "getCurrentMonth";

		_methodParameterTypes23 = new String[] {  };

		_methodName24 = "getCurrentYear";

		_methodParameterTypes24 = new String[] {  };

		_methodName25 = "getMounths";

		_methodParameterTypes25 = new String[] {  };

		_methodName26 = "getYears";

		_methodParameterTypes26 = new String[] {  };

		_methodName27 = "getUserSchedules";

		_methodParameterTypes27 = new String[] {  };

		_methodName28 = "getUserSchedules";

		_methodParameterTypes28 = new String[] { "int", "int", "java.lang.String" };

		_methodName29 = "countUserSchedules";

		_methodParameterTypes29 = new String[] { "java.lang.String" };

		_methodName30 = "allowDisplaySchedule";
	...
	public com.fsoft.bn.model.Schedule addSchedule(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(schedule) });
		}
		catch (Throwable t) {
		...
		return (com.fsoft.bn.model.Schedule)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.fsoft.bn.model.Schedule createSchedule(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(schedule_id) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.fsoft.bn.model.Schedule> getSchedules(int start,
		...
		return (java.util.List<com.fsoft.bn.model.Schedule>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.fsoft.bn.model.Schedule updateSchedule(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(schedule), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.fsoft.bn.domain.ScheduleModel> getScheduleBy(
		...
		return (java.util.List<com.fsoft.bn.domain.ScheduleModel>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.fsoft.bn.domain.DataDictionary> getMounths() {
		...
		return (java.util.List<com.fsoft.bn.domain.DataDictionary>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.fsoft.bn.domain.UserScheduleModel> getUserSchedules()
		...
		return (java.util.List<com.fsoft.bn.domain.UserScheduleModel>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void allowDisplaySchedule(java.lang.String[] userIDs)
		...
		try {
			_invokableLocalService.invokeMethod(_methodName30,
				...
				new Object[] { ClpSerializer.translateInput(userIDs) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
