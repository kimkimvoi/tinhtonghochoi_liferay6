...
/**
 * Utils for handling common task with PortletRequest
 * 
 * @author ThangBN1
 * 
 */
public class PortletRequestUtil {
	...
	/**
	 * Get an Integer parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a number.
	 * 
	 * @param request
	 *            current HTTP request
	 * @param name
	 *            the name of the parameter
	 * @return the Integer value, or {@code null} if not present @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get an int parameter, with a fallback value. Never throws an exception. Can pass a distinguished value as default to enable checks of
	 ...
	 *            current HTTP request
	 * @param name
	 *            the name of the parameter @ a subclass of ServletException, so it doesn't need to be caught
	 */
	 ...
	 *            current HTTP request
	 * @param name
	 *            the name of the parameter with multiple possible values @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a Long parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a number.
	 * 
	 * @param request
	 *            current HTTP request
	 * @param name
	 *            the name of the parameter
	 * @return the Long value, or {@code null} if not present @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a long parameter, with a fallback value. Never throws an exception. Can pass a distinguished value as default to enable checks of
	 * whether it was supplied.
	 * 
	 * @param request
	 *            current HTTP request
	...
	/**
	 * Get a Float parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a number.
	 * 
	 * @param request
	 *            current HTTP request
	 * @param name
	 *            the name of the parameter
	 * @return the Float value, or {@code null} if not present @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a float parameter, with a fallback value. Never throws an exception. Can pass a distinguished value as default to enable checks
	 * of whether it was supplied.
	 * 
	 * @param request
	 *            current HTTP request
	 * @param name
	 ...
	 * @param name
	 *            the name of the parameter
	 * @return the Double value, or {@code null} if not present @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a double parameter, with a fallback value. Never throws an exception. Can pass a distinguished value as default to enable checks
	 * of whether it was supplied.
	 * 
	 * @param request
	 *            current HTTP request
	...
	/**
	 * Get a Boolean parameter, or {@code null} if not present. Throws an exception if it the parameter value isn't a boolean.
	 * <p>
	 * Accepts "true", "on", "yes" (any case) and "1" as values for true; treats every other non-empty value as false (i.e. parses
	 * leniently).
	 * 
	 * @param request
	 *            current HTTP request
	 * @param name
	 *            the name of the parameter
	 * @return the Boolean value, or {@code null} if not present @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a boolean parameter, with a fallback value. Never throws an exception. Can pass a distinguished value as default to enable checks
	 * of whether it was supplied.
	 * <p>
	 * Accepts "true", "on", "yes" (any case) and "1" as values for true; treats every other non-empty value as false (i.e. parses
	 * leniently).
	 ...
	 * @param name
	 *            the name of the parameter
	 * @return the String value, or {@code null} if not present @ a subclass of ServletException, so it doesn't need to be caught
	 */
	...
	/**
	 * Get a String parameter, with a fallback value. Never throws an exception. Can pass a distinguished value to default to enable checks
	 * of whether it was supplied.
	 * 
	 * @param request
	 *            current HTTP request
	...
	private abstract static class ParameterParser<T> {
		...
		protected final T parse(String name, String parameter) {
			...
			try {
				...
				throw new RuntimeException("Required " + getType() + " parameter '" + name + "' with value of '" + parameter
		...
		protected final void validateRequiredParameter(String name, Object parameter) {
			...
			if (parameter == null) {
				throw new RuntimeException("can not parse " + name + getType());
			}
		}
	...
	private static class BooleanParser extends ParameterParser<Boolean> {
		...
		protected Boolean doParse(String parameter) throws NumberFormatException {
			return (parameter.equalsIgnoreCase("true") || parameter.equalsIgnoreCase("on") || parameter.equalsIgnoreCase("yes") || parameter
					.equals("1"));
		}
