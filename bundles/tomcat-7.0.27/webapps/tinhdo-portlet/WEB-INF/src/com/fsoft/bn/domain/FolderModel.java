...
import com.fsoft.bn.constant.CommonConstants.STRUCTURE;
...
public class FolderModel implements Serializable {
	...
	public static void main(String[] args) {
		// Home folder
		FolderModel rootFolder = new FolderModel(0, CommonConstants.FOLDER_HOME, CommonConstants.FOLDER_HOME, -1, STRUCTURE.GROUP_ID);
