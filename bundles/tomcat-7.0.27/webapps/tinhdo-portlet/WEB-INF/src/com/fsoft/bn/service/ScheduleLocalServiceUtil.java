...
/**
 * The utility for the schedule local service. This utility wraps {@link com.fsoft.bn.service.impl.ScheduleLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class ScheduleLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.fsoft.bn.service.impl.ScheduleLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.fsoft.bn.model.Schedule addSchedule(
	...
	*/
	public static com.fsoft.bn.model.Schedule createSchedule(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.fsoft.bn.model.Schedule deleteSchedule(
		java.lang.String schedule_id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSchedule(schedule_id);
	}
	...
	*/
	...
	public static com.fsoft.bn.model.Schedule fetchSchedule(
		java.lang.String schedule_id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.fsoft.bn.model.Schedule getSchedule(
		java.lang.String schedule_id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.fsoft.bn.model.Schedule> getSchedules(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.fsoft.bn.model.Schedule updateSchedule(
		com.fsoft.bn.model.Schedule schedule)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @author KienNN
	*/
	public static java.util.List<com.fsoft.bn.domain.ScheduleModel> getScheduleBy(
		int month, int year, java.util.Locale locale)
		throws java.lang.Exception {
		return getService().getScheduleBy(month, year, locale);
	}
	...
	*/
	public static java.util.List<com.fsoft.bn.domain.ScheduleModel> getScheduleBy(
		...
		throws java.lang.Exception {
		return getService().getScheduleBy(userId, month, year, locale);
	}
	...
	* @author KienNN
	*/
	public static java.util.List<com.fsoft.bn.domain.ScheduleModel> getWeekScheduleBy(
		int weekOfYear, int month, int year, java.util.Locale locale)
		throws java.lang.Exception {
		return getService().getWeekScheduleBy(weekOfYear, month, year, locale);
	}
	...
	*/
	public static void deleteSchedule(java.lang.String userId,
		java.util.Date date)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteSchedule(userId, date);
	}

	public static int getCurrentMonth() {
		return getService().getCurrentMonth();
	}

	public static int getCurrentYear() {
		return getService().getCurrentYear();
	}
	...
	* @return
	*/
	public static java.util.List<com.fsoft.bn.domain.DataDictionary> getMounths() {
		return getService().getMounths();
	}
	...
	* @return
	*/
	public static java.util.List<com.fsoft.bn.domain.DataDictionary> getYears() {
		return getService().getYears();
	}
	...
	* @throws Exception
	*/
	public static java.util.List<com.fsoft.bn.domain.UserScheduleModel> getUserSchedules()
		throws java.lang.Exception {
		return getService().getUserSchedules();
	}
	...
	*/
	public static java.util.List<com.fsoft.bn.domain.UserScheduleModel> getUserSchedules(
		...
		throws java.lang.Exception {
		return getService().getUserSchedules(start, end, keyword);
	}
	...
	* @throws Exception
	*/
	public static int countUserSchedules(java.lang.String keyword)
		throws java.lang.Exception {
		return getService().countUserSchedules(keyword);
	}
	...
	* @throws Exception
	*/
	public static void allowDisplaySchedule(java.lang.String[] userIDs)
		throws java.lang.Exception {
		getService().allowDisplaySchedule(userIDs);
	}
